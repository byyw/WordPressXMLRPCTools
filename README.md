...
> fork自[https://github.com/zhaoolee/WordPressXMLRPCTools](https://github.com/zhaoolee/WordPressXMLRPCTools)

目前使用WordPress搭建了个人博客[八云妖の隙间](https://blog.byywer.com/)，但平时写文章习惯使用 Markdown，故搜寻了一番，最终决定采用本方案，在将文章上传到 GitHub 后，同步至博客，并发布。
